...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_sphere()
      ...
      assert_equal( 113.10, volume_of_sphere_result)
  end

  # #You can add your own converters
  def test_fahrenheit_to_celsius()
        fahrenheit_to_celsius_result = fahrenheit_to_celsius(212)
        assert_equal( 100, fahrenheit_to_celsius_result )
  end

  def test_miles_to_kilometres()
        miles_to_kilometres_result = miles_to_kilometres(10)
        assert_equal( 16.09, miles_to_kilometres_result)
  end
